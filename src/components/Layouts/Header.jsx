...
export default function Header() {
  ...
  return (
      <>
        <header className="hidden w-full bg-header-black justify-between items-center text-white md:flex">
        ...
        <header className="w-full bg-header-black pl-4 flex justify-between items-center text-white md:hidden">
